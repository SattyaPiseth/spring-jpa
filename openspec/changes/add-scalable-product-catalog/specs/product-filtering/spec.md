...
The system SHALL allow GET /products to be filtered by an optional categoryId parameter while preserving paging and sorting behavior. The filter SHALL match products associated to that category via primary or additional category links.
